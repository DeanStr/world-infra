...
- follow-up hardening release-candidate proof:
  `world-infra-v0.1.0-rc.8`.

Consumer: Chairman.

Owner: Chairman world-infra DRI.

Date: 2026-06-27; exact-revision rc7 and rc8 reruns on 2026-06-28.
...
- 2026-06-28 rc7 focused gate: `cargo fmt --check` passed; `chairman-api`
